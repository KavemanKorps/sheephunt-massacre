...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("shooter-game", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("shooter-game", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "shooter-game";
		app.meta["name"] = "shooter-game";
